...
def search_results():
    ...
    if sequence == '':
        if 'fasta file' in request.files:
            ...
            if seqs is None:
                return('Error: Uploaded file not recognized as fasta <br> Please use <a href=https://en.wikipedia.org/wiki/FASTA_format>fasta</a> formatted files without ";" comment lines', 400)
